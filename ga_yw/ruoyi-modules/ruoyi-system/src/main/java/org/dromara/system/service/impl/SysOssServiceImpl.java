...
public class SysOssServiceImpl implements ISysOssService, OssService {
    ...
    public List<SysOssVo> listByIds(Collection<Long> ossIds) {
        return baseMapper.selectVoBatchIds(ossIds);
    }
     ...
     */
    @Override
    public List<SysOssVo> listByIdsWithCache(Collection<Long> ossIds) {
...
//    @Cacheable(cacheNames = CacheNames.SYS_OSS, key = "#ossId")
    ...
    public void download(Long ossId, HttpServletResponse response) throws IOException {
        ...
        if(RuoYiConfig.isLocal()){
            String downloadPath = RuoYiConfig.getProfile() + StringUtils.substringAfter(sysOss.getUrl(), Constants.RESOURCE_PREFIX);
            //TODO 加入异常处理代码
            try{
    ...
    private SysOssVo saveLocalFile(MultipartFile file){
        try{
            String originalfileName = file.getOriginalFilename();
    ...
    private String getSuffix(String name){
        return StringUtils.substring(name, name.lastIndexOf("."), name.length());
    }
