...
export const dynamicRoutes: RouteRecordRaw[] = [
  ...
  {
    path: '/system/project-sla',
    component: Layout,
    hidden: true,
    permissions: ['workProject:project:list'],
    children: [
      {
        path: 'index/:projectId(\\d+)',
        component: () => import('@/views/workProject/projectSla/index.vue'),
        name: 'ProjectSlq',
        meta: { title: '项目事件', activeMenu: '/workProject/project', icon: '' }
      }
    ]
  },
