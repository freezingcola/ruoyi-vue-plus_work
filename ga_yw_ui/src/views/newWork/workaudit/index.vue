        ...
        <el-card shadow="hover">
            <el-form ref="queryFormRef" :model="queryParams" :inline="true">
                ...
                <el-form-item label="项目名称" prop="projectName">
                    <el-select filterable v-model="queryParams.projectName" placeholder="请选择项目名称" clearable>
                        <el-option v-for="projectItem in project" :key="projectItem.id"  :label="projectItem.proName"  :value="projectItem.id"  />
                    </el-select>
                </el-form-item>
                ...
                <el-form-item filterable label="接收人" prop="acceptAccount">
                    <el-select v-model="queryParams.acceptAccount" placeholder="请选择接收人" clearable>
                        <el-option v-for="name in nickName" :key="name.userId" :label="name.nickName" :value="name.userId" />
                    </el-select>
                </el-form-item>
...
<!--        <el-table-column label="id" align="center" prop="id" v-if="true" />-->
        <el-table-column label="流水号" align="center" prop="number" width="180">
          <template #default="scope">
            <span :style="{ color: '#009fff' }" @click="goToDetailPage(scope.row)">{{ scope.row.number }}</span>
          </template>
        </el-table-column>
        <el-table-column label="标题" align="left"   prop="workTitle" />
...
<!--        </el-table-column>-->
        ...
        <el-table-column label="状态" align="center" width="75" prop="state">
          <template #default="scope">
...
<!--        <el-table-column label="创建人1" align="center" width="110" prop="createByName" />-->
        <el-table-column label="创建人" align="center" width="110" prop="acceptAccountName" />
        <el-table-column label="接收人" align="center" width="110" prop="acceptAccountName" />
<!--        <el-table-column label="附件fff" align="center">-->
<!--          <template #default="scope">-->
...
<!--        </el-table-column>-->
        <el-table-column label="创建时间" align="center" prop="createTime" width="200">
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
              <template #default="scope">
                  <el-button v-if="scope.row.state == '4'" type="warning" @click="handleAudit(scope.row)">审核</el-button>
                  <el-tooltip content="修改" placement="top">
                      <el-button v-hasPermi="['workInfo:workInfo:edit']"  type="primary" icon="Edit" @click="handleUpdate(scope.row)"></el-button>
                  </el-tooltip>
