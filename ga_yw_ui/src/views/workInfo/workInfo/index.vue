        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['workInfo:workInfo:edit']" link type="primary" icon="Edit" @click="handleUpdate(scope.row)"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermi="['workInfo:workInfo:remove']" link type="primary" icon="Delete" @click="handleDelete(scope.row)"></el-button>
            </el-tooltip>
            ...
            <el-button link type="text" class="el-button--primary" @click="openWorkinfolog(scope.row)">处理过程12312</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-form ref="workInfoFormRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目名称" prop="projectName">
          <el-select v-model="form.projectName" placeholder="请选择项目名称">
            <el-option v-for="dict in test_xm" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="分类" prop="classificationType">
          <el-select v-model="form.classificationType" placeholder="请选择工单分类">
            <el-option v-for="dict in test_fl" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="类型" prop="workType">
          <el-select v-model="form.workType" placeholder="请选择工单类型">
            <el-option v-for="dict in work_info_type" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
          </el-select>
        </el-form-item>
...
import { listProject } from '@/api/workProject/project';
