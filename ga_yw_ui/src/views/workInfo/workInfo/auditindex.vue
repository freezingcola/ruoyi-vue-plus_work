...
<!--            </el-tooltip>-->
            ...
            <el-button v-hasRoles="['an_captain']" v-if="scope.row.state == '4'" link type="text" class="el-button--primary" @click="handleAudit(scope.row)" >审核</el-button>

            <el-button link type="text" class="el-button--primary" @click="openWorkinfolog(scope.row)" >处理过程44</el-button>
          </template>
        </el-table-column>
      </el-table>
