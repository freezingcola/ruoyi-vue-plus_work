<template>
  <div class="login">
    <Particles id="tsparticles" class="login__particles" :options="ParticlesOptions"></Particles>
    <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="login-form">
      <h3 class="title">集成化运维资源调度与配置平台</h3>
      ...
      <el-checkbox v-model="loginForm.rememberMe" style="margin: 0 0 25px 0; color: #fff">记住密码</el-checkbox>
